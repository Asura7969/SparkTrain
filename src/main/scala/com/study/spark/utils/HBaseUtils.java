...
public class HBaseUtils {
    ...
    private HBaseUtils(){
        ...
        configration.set("hbase.zookeeper.quorum", "node02:2181,node03:2181,node04:2181");
        configration.set("hbase.rootdir", "hdfs://mycluster/hbase");
        try {
    ...
    public static void main(String[] args) {
        String tableName = "categroy_clickcount";
